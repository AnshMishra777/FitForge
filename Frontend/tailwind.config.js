...
export default {
  ...
  // ✅ FIX 1 — enables .dark class on <html> to control dark/light mode
  darkMode: 'class',
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        pulseGlow: { '0%, 100%': { boxShadow: '0 0 0 0 rgba(255,90,31,0.35)' }, '50%': { boxShadow: '0 0 0 8px rgba(255,90,31,0)' } },
        typing:    { '0%, 80%, 100%': { opacity: '0.2', transform: 'scale(0.8)' }, '40%': { opacity: '1', transform: 'scale(1)' } },
      },
      boxShadow: {
