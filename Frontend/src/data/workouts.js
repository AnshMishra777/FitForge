...
import straightArmPulldownImg from '../exercises/Straight arm pulldown.webp'
import facePull from '../exercises/Face Pull.webp'
import barbellShrug from '../exercises/Barbell Shrug.jpg'
...
export const PROGRAMS = [
  ...
  goal: 'Muscle Growth',
  description:
    'Advanced hypertrophy-focused split with high volume, progressive overload, isolation work, and balanced recovery.',
  ...
  schedule: [
    ...
    // ── DAY 2 PULL ─────────────────────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 't_bar_row', sets: 3, reps: 10 },
    ...
    // ── DAY 3 LEGS ─────────────────────────────
    {
      ...
      exercises: [
        { exerciseId: 'squat', sets: 4, reps: 8 },
        { exerciseId: 'front_squat', sets: 3, reps: 8 },
        ...
        { exerciseId: 'calf_raise', sets: 5, reps: 20 },
        { exerciseId: 'step_up', sets: 3, reps: 12 },
      ],
    },
    ...
    // ── DAY 5 UPPER BODY + CORE ───────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 'plank', sets: 3, duration: 60, isTime: true },
        { exerciseId: 'side_plank', sets: 3, duration: 30, isTime: true },
        { exerciseId: 'leg_raise', sets: 3, reps: 15 },
        { exerciseId: 'russian_twist', sets: 3, reps: 25 },
    ...
    // ── DAY 6 CARDIO + ABS ────────────────────
    {
      ...
      label: 'Conditioning',
      exercises: [
        { exerciseId: 'jump_rope', sets: 4, duration: 60, isTime: true },
        { exerciseId: 'burpee', sets: 4, reps: 12 },
        { exerciseId: 'box_jump', sets: 4, reps: 10 },
        { exerciseId: 'high_knee', sets: 4, duration: 30, isTime: true },

        { exerciseId: 'crunch', sets: 4, reps: 25 },
        { exerciseId: 'bicycle_crunch', sets: 3, reps: 30 },
        { exerciseId: 'dead_bug', sets: 3, reps: 12 },
      ],
    },
  ...
  goal: 'Max Strength',
  description:
    'Advanced strength-focused powerlifting program built around squat, bench press, and deadlift with heavy compound work, accessory movements, and recovery balance.',
  ...
  schedule: [
    ...
    // ── DAY 1 SQUAT DAY ─────────────────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 'front_squat', sets: 4, reps: 6 },
    ...
    // ── DAY 3 BENCH DAY ─────────────────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 'close_grip_bench', sets: 4, reps: 6 },
    ...
    // ── DAY 5 DEADLIFT DAY ──────────────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 't_bar_row', sets: 4, reps: 8 },
    ...
    // ── DAY 6 ACCESSORY + CORE ──────────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 'hip_thrust', sets: 4, reps: 10 },
        { exerciseId: 'glute_bridge', sets: 3, reps: 15 },

        { exerciseId: 'calf_raise', sets: 5, reps: 20 },

        { exerciseId: 'plank', sets: 3, reps: 1, isTime: true, duration: 75 },
        { exerciseId: 'russian_twist', sets: 3, reps: 30 },
        { exerciseId: 'mountain_climber', sets: 3, reps: 40 },
      ],
    },
  ...
  description:
    'Advanced HIIT fat-loss program combining explosive cardio, metabolic conditioning, bodyweight training, and strength endurance while preserving lean muscle mass.',
  ...
  schedule: [
    ...
    // ── DAY 1 UPPER HIIT ───────────────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 'pull_up', sets: 4, reps: 8 },
        { exerciseId: 'barbell_row', sets: 4, reps: 10 },
        { exerciseId: 'lat_pulldown', sets: 3, reps: 12 },

        { exerciseId: 'mountain_climber', sets: 4, reps: 40 },
        { exerciseId: 'jumping_jack', sets: 4, reps: 50 },
    ...
    // ── DAY 2 LOWER HIIT ───────────────────────
    {
      ...
      label: 'Lower HIIT',
      exercises: [
        { exerciseId: 'box_jump', sets: 5, reps: 10 },

        { exerciseId: 'squat', sets: 4, reps: 12 },
        { exerciseId: 'front_squat', sets: 3, reps: 10 },

        { exerciseId: 'lunge', sets: 3, reps: 24 },
        { exerciseId: 'reverse_lunge', sets: 3, reps: 16 },
        { exerciseId: 'bulgarian_split_squat', sets: 3, reps: 10 },

        { exerciseId: 'leg_press', sets: 3, reps: 15 },
        { exerciseId: 'calf_raise', sets: 4, reps: 25 },
    ...
    // ── DAY 3 ACTIVE RECOVERY ──────────────────
    {
      ...
      exercises: [
        { exerciseId: 'treadmill_walk', sets: 1, duration: 1800, isTime: true },
        { exerciseId: 'jump_rope', sets: 3, duration: 60, isTime: true },
    ...
    // ── DAY 5 CARDIO + CORE ────────────────────
    {
      ...
      label: 'Cardio + Core',
      exercises: [
        { exerciseId: 'jump_rope', sets: 5, duration: 60, isTime: true },
        { exerciseId: 'treadmill_walk', sets: 1, duration: 1200, isTime: true },

        { exerciseId: 'mountain_climber', sets: 4, reps: 40 },
        { exerciseId: 'jumping_jack', sets: 4, reps: 60 },

        { exerciseId: 'plank', sets: 4, duration: 60, isTime: true },
        { exerciseId: 'side_plank', sets: 3, duration: 45, isTime: true },

        { exerciseId: 'crunch', sets: 4, reps: 30 },
        { exerciseId: 'bicycle_crunch', sets: 4, reps: 30 },

        { exerciseId: 'leg_raise', sets: 4, reps: 15 },
        { exerciseId: 'russian_twist', sets: 4, reps: 30 },

        { exerciseId: 'dead_bug', sets: 3, reps: 15 },
      ],
    },
    ...
    // ── DAY 6 METABOLIC CIRCUIT ─────────────────
    {
      ...
      exercises: [
        ...
        { exerciseId: 'box_jump', sets: 4, reps: 12 },
        { exerciseId: 'jump_rope', sets: 4, duration: 75, isTime: true },

        { exerciseId: 'push_up', sets: 4, reps: 25 },
        { exerciseId: 'pull_up', sets: 3, reps: 10 },

        { exerciseId: 'squat', sets: 4, reps: 15 },
        { exerciseId: 'lunge', sets: 3, reps: 20 },

        { exerciseId: 'mountain_climber', sets: 5, reps: 40 },
        { exerciseId: 'high_knee', sets: 5, duration: 30, isTime: true },

        { exerciseId: 'plank', sets: 3, duration: 75, isTime: true },
      ],
    },
